  ...
  return (
    <div className="panel">
      ...
      <ul>
        ...
        <li>
          Su una casella prodotto/servizio libera puoi <b>acquisirne la licenza</b> pagando il valore indicato.
        </li>
        <li>
          Se la casella è già di un altro giocatore, gli paghi il <b>canone</b> indicato.
        </li>
        <li>
          Le caselle dello stesso colore formano una <b>Linea di business</b>: chi la possiede per intero può rilasciare
          🔄 <b>Aggiornamenti</b> (case) e una 🚀 <b>Major Release</b> (hotel) per aumentare il canone dovuto.
        </li>
      ...
      <ul className="special-list">
        ...
        <li>
          ...
          <span>
            <b>Enel / Impianto clima</b> (2) — come le &quot;società&quot; classiche: l&apos;importo dovuto dipende dal
            tiro di dado.
          </span>
        </li>
        <li>
        ...
        <li>
          <span className="ic">👥</span>
          <span>
            <b>Riunione / Transito</b> — la &quot;prigione&quot; del Monopoli classico: di passaggio o convocato in
            sosta forzata.
          </span>
        </li>
        <li>
