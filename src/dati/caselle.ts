...
export const CASELLE: readonly Casella[] = [
  ...
  /*  3 */ { tipo: "proprieta", gruppo: "brown", reparto: "Store", nome: "Accessori", prezzo: 60 },
  ...
  /* 11 */ { tipo: "proprieta", gruppo: "pink", reparto: "Consulenza", nome: "Consulenza Nord Italia", prezzo: 140 },
  /* 12 */ { tipo: "speciale", icona: "⚡", nome: "Enel", prezzo: 150 },
  /* 13 */ { tipo: "proprieta", gruppo: "pink", reparto: "Consulenza", nome: "Consulenza Centro Italia", prezzo: 140 },
  /* 14 */ { tipo: "proprieta", gruppo: "pink", reparto: "Consulenza", nome: "Consulenza Sud Italia", prezzo: 160 },
  /* 15 */ { tipo: "speciale", icona: "📡", nome: "Fastweb", prezzo: 200 },
  /* 16 */ { tipo: "proprieta", gruppo: "orange", reparto: "Trasporti", nome: "Tachigrafo", prezzo: 180 },
  /* 17 */ { tipo: "carta", icona: "❓", nome: "Probabilità" },
  /* 18 */ { tipo: "proprieta", gruppo: "orange", reparto: "Trasporti", nome: "Carico sicuro", prezzo: 180 },
  /* 19 */ { tipo: "proprieta", gruppo: "orange", reparto: "Trasporti", nome: "Guida sicura", prezzo: 200 },
