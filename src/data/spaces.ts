...
export const SPACES: readonly Space[] = [
  ...
  /*  1 */ { type: "property", group: "pink", department: "Configurazione", name: "SIDA Sync Test", price: 150 },
  /*  2 */ { type: "card", icon: "❓", name: "Probabilità" },
  /*  3 */ { type: "property", group: "pink", department: "Configurazione", name: "SIDA Connect", price: 150 },
  ...
  /* 11 */ { type: "property", group: "orange", department: "Web", name: "patenteonline.it", price: 350 },
  /* 12 */ { type: "special", icon: "⚡", name: "Enel", price: 380 },
  /* 13 */ { type: "property", group: "orange", department: "Web", name: "patente.it", price: 350 },
  /* 14 */ { type: "property", group: "orange", department: "Web", name: "sida.patente.it", price: 400 },
  /* 15 */ { type: "special", icon: "🧑‍💼", name: "Consulenza Ovest", price: 480 },
  /* 16 */ { type: "property", group: "brown", department: "Mobile", name: "SIDA QuizApp", price: 450 },
  /* 17 */ { type: "card", icon: "❓", name: "Probabilità" },
  /* 18 */ { type: "property", group: "brown", department: "Mobile", name: "SIDA Tools", price: 450 },
  /* 19 */ { type: "property", group: "brown", department: "Mobile", name: "SIDA Drive Controller", price: 500 },
